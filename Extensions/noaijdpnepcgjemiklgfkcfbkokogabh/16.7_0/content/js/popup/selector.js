...
window.onresize = function() {
	window.resizeTo(495,GEBI('SL_body').clientHeight+60);
}
   ...
   if(!document.getElementById("PL_lbframe")){
    ...
    document.getElementById('SL_TTS_player'+box).appendChild(die);
            ...
            http.onload = e => {
		     ...
		     audioElement.setAttribute('style', 'width:470px;margin-top:-15px;margin-left:-20px;');
...
function SLDetector (text){
	...
	var SLDImTranslator_url = ImTranslator_theurl+"ld.php?tr=pl&text="+encodeURIComponent(newTEXT);
