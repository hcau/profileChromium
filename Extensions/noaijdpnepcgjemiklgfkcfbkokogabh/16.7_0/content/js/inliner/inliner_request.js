...
// By VK ------ Translation goes without the detection engine-------------
	...
	// By VK ------ Translation goes without the detection engine-------------
        SL_Params = "client=dict-chrome-ex&sl=auto&tl=" + langDst + "&multires=1&otf=2&ssel=0&tsel=0&notlr=0&sc=1&tk=" + tk + "&text=" + encodeURIComponent(dictionaryWord.toLowerCase());
	// By VK ------ Translation goes without the detection engine-------------
